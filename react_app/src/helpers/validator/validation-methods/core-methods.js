 ...
 */
export const getInputsForValidate = (formValue, key) => {
  ...
  */
  export const mapInputKey = (realInputKey, keyToMap) => {
 ...
 * @param {Function} cb callback function
 */
const requiredIf = (key, values, param, message, filedList,additionalParam, cb) => {
  try {
...
const maxAmount = (key, values, param, message, filedList,additionalParam, cb) => {
  try {
...
const valueIn = (key, values, param, message, filedList,additionalParam, cb) => {
  try {
